...
| `B1` | Real-world Rust stability benchmark | Proposed branch-scoped candidate: activate one observational same-host suite over pinned Lekton success and RustDesk typed fail-closed behavior. B1a adds the exact 75-second benchmark-only selector; B1b corrects bootstrap identity; B1c retains bounded privacy-safe failed-sample identity after the first nondeterministic observation. | Issues #205/#206/#207/#208, Decisions 0042/0043/0044/0045, first selector-supporting baseline `cce84869430ef129f55591998b30ea2ea728e1c3`, no dependency or post-B1a Rust product change. | Separate reports retain every sample; a failure retains public entry/index/exit/lengths, exact stderr digest, and only allowlisted typed identity without source/private output. No retry, SLO, cross-host, release, or acceptance-completion claim. |
...
| `G7` | Performance and capacity | Issues #205-#208 / Decisions 0042-0045 propose the first B1 observational package, its exact execution/baseline corrections, and bounded failed-sample diagnostics. Reference-release, load, soak, stress, chaos, capacity and contractual SLO work remain future G7. | `NFR-PER-001`; bounded `NFR-OBS-001`; `NFR-PER-002`, `OD-LIM-001`, `OD-SLO-001`, `S14` remain unresolved beyond existing bounded product limits | Exact pinned outcomes and same-host policy pass with no discarded failures; failure evidence is bounded and privacy-safe; no release-artifact, availability, cross-host, support, conference or GA claim. |
