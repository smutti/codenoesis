...
| `B1` | Real-world Rust stability benchmark | Proposed branch-scoped candidate: B1/B1a/B1b establish the observational suite, selector, and bootstrap identity; B1c retains bounded failed-sample identity; B1d restores gate readiness and adds one closed opaque-error category. | Issues #205-#209, Decisions 0042-0046, exact `cce8486` baseline binary, one authorized semantics-neutral R16 parser extraction, no dependency. | Complete gate passes; V2/V3 historical artifacts remain immutable; one additional Lekton diagnostic retains only bounded identity/category and stops. No retry, SLO, cross-host, release, or acceptance-completion claim. |
