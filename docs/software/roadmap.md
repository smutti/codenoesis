...
6. RW2 regenerates pinned Lekton and RustDesk R16 ontology artifacts and
   confirms deterministic RustDesk semantic replay.
7. Run the ontology information adequacy audit on every real-world pilot.
8. Build the LLM-ready projection over verified callable, evidence, source, and
