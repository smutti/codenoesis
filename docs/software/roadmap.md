...
| `B1` | Real-world Rust stability benchmark | Proposed branch-scoped candidate: activate one observational same-host suite over pinned Lekton success and RustDesk typed fail-closed behavior with raw samples and exact semantic/outcome comparison. Dependent B1a proposes one explicit 75-second whole-scan limit only for the exact benchmark R16 composition. | Issues #205/#206, Decisions 0042/0043, exact V3 baseline `3fb6504d1d6cb39f204eca032ff816266194e1ec`, dependent B1 head `74bd959128472c3e95baeb5fd1a29cfc09b2c686`, no dependency. | Three baseline and three candidate runs per entry retain every sample, exact semantic/outcome identity, 60-second selector-absent compatibility, exact 75-second benchmark boundary, complete NFR-PER-001 context, reviewed p95 policy, privacy/no-network/no-target-execution controls, and no SLO or cross-host claim. |
