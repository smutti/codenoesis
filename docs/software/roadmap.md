...
| `G1` | Distribution and configuration | Protected PR #183 made the issue #182 G1a closed local CLI configuration and unsigned digest-named staged-directory bundle Approved and Implemented but not Verified, signed, supported, published, or GA. Server artifacts, non-empty secret references, installers, release channels, signing, publication, support, and GA remain future G1/G5/G8/G9 work. | `FR-CFG-001`, `FR-REL-002`, `FR-CLI-008`; bounded `FR-CLI-002`, `NFR-CMP-001`, `NFR-SEC-003`, `NFR-PORT-001`, Decision 0034, `S14` | Embedded/explicit validation, invalid/unstable configuration, deterministic packaging, failure atomicity, actual-binary smoke, clean install, two-generation side-by-side rehearsal, rollback, and uninstall pass without hidden state or secret leakage. |
| `G2` | Compatibility and migration | Proposed issue #184 G2a candidate: preflight one exact side-by-side G1a transition and exact-plan rollback, reject arbitrary downgrade, and classify the identical immutable V1 configuration as requiring no migration. Database, ontology, REST, MCP, WIT, plugin and server migration remain future G2 work. | Proposed `FR-CMP-001`, `FR-CLI-009`; bounded `FR-REL-002`, `NFR-CMP-001`, local `NFR-SEC-*`/`NFR-PRV-002`, observational `NFR-PER-001`, `OD-LIM-001`, Decision 0035, `S14` | Exact two-generation fixtures emit canonical plan/report bytes; tamper, substitution, path, race, privacy, limit and unsupported-contract cases fail closed; rollback requires the exact prior plan and performs no activation or mutation. |
