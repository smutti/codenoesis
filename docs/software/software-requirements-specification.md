...
### 2.34 Local Upgrade Safety G2a/G5-local/G7a candidate register

Issue [#184](https://github.com/smutti/codenoesis/issues/184), the accountable
maintainer's high-risk authorization, and
[Decision 0035](decisions/0035-local-upgrade-safety.md) govern one
branch-scoped candidate on exact protected base
`e7643d83965dca2f9342080264e7c6c58f3dd761`. Governance, schemas, target
goldens, invalid/security oracle, retained Red, implementation, observational
benchmark, tests, traceability and evidence share one supervised pull request.
Before protected merge every requirement and implementation statement remains
Proposed/candidate.

| Requirement | Current state | Candidate after protected merge | Slice | Ratification material |
|---|---|---|---|---|
| `FR-CMP-001` | Proposed, branch-scoped implementation candidate | Approved and Implemented only for one output-only exact G1a side-by-side transition plan and exact-plan rollback report; arbitrary downgrade and unsupported contracts fail closed; not Verified or a general compatibility promise | `S14` | Issue #184, Decision 0035, exact target goldens, two-generation fixture, invalid/security matrix, retained Red/Green, and complete gate |
| `FR-CLI-009` | Proposed, branch-scoped implementation candidate | Approved and Implemented only for `xtask preflight-local-upgrade` and `xtask preflight-local-rollback` with exact arguments, streams, exits, bounds and no mutation; not Verified | `S14` | Issue #184, Decision 0035, public E2E oracle, ErrorV27 schema/goldens, determinism and privacy evidence |
| Bounded amendments to `FR-REL-002`, `NFR-CMP-001`, `NFR-SEC-001/003/005`, `NFR-PRV-002`, `NFR-PER-001`, `NFR-TST-001/002`, `INV-BND-001`, and the local-transition subset of `OD-LIM-001` | Existing deterministic, bounded, offline, private, Red-first controls Approved | Add only exact two-bundle validation, exact-plan rollback, local tamper/race/privacy rejection, 65,536-byte plan bound and observational benchmark evidence; no migration engine, SLO, support, signing, publication or GA | `S14` | Issue #184, Decision 0035, `codenoesis.g2-local-upgrade-safety-contract/v1`, and protected-base authority |
