...
| Bounded R12 amendment to `FR-CLI-001` | Prior local journeys Approved | `Approved` for the explicit R10+R6+K1 scan/docs/query/export/explore journey and ErrorV19 failures | `S4` | Decision 0023, ErrorV19, and machine oracle |
...
contract bundle `sha256:73d4a54f8f6ac7e4157f1221a7d5c67a37bca68e87703fd15b916a2622e67241`.
SRS, roadmap, retained Red, production source, and implementation evidence are
excluded from that semantic digest.
