...
> Status: **0.9+r15 — S0 through S6 and R0-R14 plus K1 are implemented but
> not Verified; R15 is a branch-authorized Proposed candidate**. Protected
> merges #163 and #165 made the R14 V13/V16 family and empty additive R5
> neutrality effective without changing historical bytes. Issue #166 and
> Decision 0027 define only the candidate R15 V14/V17 local-flow family.
...
| Version | `0.9` |
| Status | S0 through S6 and roadmap R0-R14 plus K1 are Approved and Implemented but not Verified. Protected merge #165 made the bounded empty-R5 correction effective. Issue #166 is an authorized high-risk S4 R15 candidate and remains Proposed until protected manual merge. |
| Date | 2026-08-11 |
