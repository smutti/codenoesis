# R14 Rust expression bindings fixture descriptor
...
source mutation. R14 facts are committed-source syntax only; `READS` and
`WRITES` are lexical occurrence facts and are not data-flow or runtime claims.
