...
use codenoesis_contracts::{
    ...
    MAX_R14_PORTABLE_GRAPH_BYTES, PortableGraphV1, PortableGraphV2, PortableGraphV3,
    PortableGraphV4, PortableGraphV5, PortableGraphV6, PortableGraphV7, R8_EXPLORER_MARKER,
...
mod tests {
    ...
    use super::{
        ...
        read_portable_graph_v6_with, read_portable_graph_v7_with, read_portable_graph_with,
    };
