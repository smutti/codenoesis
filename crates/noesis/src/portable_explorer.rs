...
use codenoesis_contracts::{
    ...
    LocalExplorerManifestV5, LocalExplorerManifestV6, MAX_K1_PORTABLE_GRAPH_BYTES,
    MAX_R8_PORTABLE_GRAPH_BYTES, MAX_R10_PORTABLE_GRAPH_BYTES, MAX_R11_PORTABLE_GRAPH_BYTES,
    MAX_R12_PORTABLE_GRAPH_BYTES, MAX_R13_PORTABLE_GRAPH_BYTES, PortableGraphV1, PortableGraphV2,
    PortableGraphV3, PortableGraphV4, PortableGraphV5, PortableGraphV6, R8_EXPLORER_MARKER,
...
mod tests {
    ...
    use super::{
        ...
        read_portable_graph_v6_with, read_portable_graph_with,
    };
