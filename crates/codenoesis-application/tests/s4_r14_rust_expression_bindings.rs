...
use codenoesis_application::{ExpressionBindingsScanError, ScanRequest, ScanService};
...
#[test]
fn gt_fr_ext_016_application_acquires_once_and_preserves_typed_r14_failure() {
        ...
        .scan_s4_r14(
            ...
            move |inventory| {
                ...
                assert_eq!(
                    ...
                    "urn:codenoesis:test:r14-application"
                );
                Err(ExpressionBindingError::PatternUnsupported)
            },
        )
        .err()
        .expect("typed R14 extraction failure");
    assert_eq!(
        error,
        ExpressionBindingsScanError::Expression(ExpressionBindingError::PatternUnsupported)
    );
        ...
        Ok(AcquiredRepository::new(
            ...
            vec![
                ...
                AcquiredFile::new(
                    ...
                    RegularFileMode::Regular,
                    oid('d'),
                    b"pub fn expression(value: i32) -> i32 { value }\n".to_vec(),
                ),
            ],
        ))
    }
...
fn request() -> ScanRequest {
    ScanRequest::new(
        ...
        RepositoryIdentity::parse("urn:codenoesis:test:r14-application")
            .expect("R14 application repository identity"),
        Revision::Commit(oid('a')),
        SnapshotEnvelopeV1::new(
            "2026-08-10T00:00:00Z".to_owned(),
            None,
            "r14-application".to_owned(),
        ),
    )
}
