...
use codenoesis_application::{ConstantEvaluationScanError, ScanRequest, ScanService};
use codenoesis_contracts::SnapshotEnvelopeV1;
use codenoesis_domain::s4_r16::ConstantEvaluationError;
...
#[test]
fn gt_fr_ext_020_application_acquires_once_and_preserves_typed_r16_failure() {
        ...
        .scan_s4_r16(
            ...
            move |inventory| {
                ...
                assert_eq!(
                    ...
                    "urn:codenoesis:test:r16-application"
                );
                Err(ConstantEvaluationError::DependencyCycle)
            },
        )
        .err()
        .expect("typed R16 extraction failure");
    assert_eq!(
        error,
        ConstantEvaluationScanError::ConstantEvaluation(ConstantEvaluationError::DependencyCycle)
    );
...
fn request() -> ScanRequest {
    ScanRequest::new(
        ...
        RepositoryIdentity::parse("urn:codenoesis:test:r16-application")
            .expect("R16 application repository identity"),
        Revision::Commit(oid('a')),
        SnapshotEnvelopeV1::new(
            "2026-08-12T00:00:00Z".to_owned(),
            None,
            "r16-application".to_owned(),
        ),
    )
}
